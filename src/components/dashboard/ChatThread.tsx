...
export default function ChatThread({
  ...
  const c = {
    empty: isDark ? "rgba(255,255,255,0.15)" : "rgba(0,0,0,0.5)",
    emptyText: isDark ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.85)",
    researchBg: isDark
    ...
    researchBorder: isDark
      ...
      : "rgba(0,0,0,0.1)",
    eventText: isDark ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.9)",
    eventDim: isDark ? "rgba(255,255,255,0.2)" : "rgba(0,0,0,0.6)",
    streamingDot: isDark ? "rgba(255,255,255,0.3)" : "rgba(0,0,0,0.6)",
  };
